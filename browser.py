...
class Mainwindow(QMainWindow):
    def __init__(self):
        ...
        #back button 
        back_btn = QAction('<<<',self)    #declaring the back btn using action 
        ...
        #forward 
        forward_btn = QAction('>>>',self) #declaring the foward btn using action 
        ...
        #reload 
        reload_btn = QAction("{{}}",self) #declaring the reload btn using action 
